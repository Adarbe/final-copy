...
def app = ''
    ...
    stage('Apply Kubernetes files') {
       withAWS(region: 'us-east-1', role: 'final-jenkins_eks', roleAccount: '555478048938', roleArn: 'arn:aws:iam::555478048938:role/final-jenkins_eks', roleSessionName: 'final-jenkins_eks'){
          sh """
